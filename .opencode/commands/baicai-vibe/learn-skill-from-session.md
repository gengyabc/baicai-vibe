...
- `@.opencode/workflows/baicai-vibe/learn-skill-from-session.md`
...
- Do not modify stable files under `.opencode/skills/baicai-vibe/`, `.opencode/workflows/baicai-vibe/`, or `.opencode/rules/baicai-vibe/`.
