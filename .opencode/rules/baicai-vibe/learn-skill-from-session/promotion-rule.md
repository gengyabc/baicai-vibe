...
This rule protects `.opencode/skills/baicai-vibe/`, `.opencode/workflows/baicai-vibe/`, and `.opencode/rules/baicai-vibe/` from noise, duplication, and under-reviewed artifacts.
...
- skill -> `.opencode/skills/baicai-vibe/<artifact-name>/SKILL.md`
- workflow -> `.opencode/workflows/baicai-vibe/<artifact-name>.md`
- rule -> `.opencode/rules/baicai-vibe/<artifact-name>.md`
...
Check for overlap in `.opencode/skills/baicai-vibe/`, `.opencode/workflows/baicai-vibe/`, and `.opencode/rules/baicai-vibe/` before promotion.
